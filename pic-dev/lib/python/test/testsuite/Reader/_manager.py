...
def mainsearch(
    ...
    if cD.checkExistVariables(variable="jsonDirection") or jsonDirection is not None:
        ...
        jR = jsonReader.JSONReader(
            direction=jsonDirection, directiontype="jsonDirection"
        )
    ...
    if cD.checkExistVariables(variable="paramDirection") or paramDirection is not None:
        ...
        if (
            ...
            or cmakeDirection is not None
        ):
            cR = cmakeReader.CMAKEFlagReader(
                direction=cmakeDirection, directiontype="cmakeDirection"
            )
            for parameter in params:
                try:
        ...
        pR = paramReader.ParamReader(
            direction=paramDirection, directiontype="paramDirection"
        )
        for parameter in params:
    ...
    if cD.checkExistVariables(variable="dataDirection") or dataDirection is not None:
        ...
        dR = dataReader.DataReader(
            direction=dataDirection, directiontype="dataDirection"
        )
