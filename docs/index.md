...
- Step-by-step [tutorials](tutorials/) including the [Quickstart](tutorials/quickstart.md), [Advanced Workflow](tutorials/advanced_workflow.md), and engineer guides for [optimization](tutorials/engineer_optimization.md) and [diagnostics interpretation](tutorials/diagnostics_interpretation.md) with an accompanying [Jupyter notebook](../examples/notebooks/quickstart.ipynb).
