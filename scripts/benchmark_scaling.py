...
def main() -> None:
    ...
    parser.add_argument(
        "--max-workers", type=int, default=4, help="maximum processes to use"
    )
    parser.add_argument(
        "--problem-size", type=int, default=100_000, help="base problem size"
    )
    parser.add_argument(
        "--outdir", type=Path, default=Path("docs/performance"), help="output directory"
    )
